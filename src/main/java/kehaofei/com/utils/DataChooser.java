...
public class DataChooser extends JPanel{
    ...
    private DataChooser(java.util.Date date, String format, int startDAY,JComponent showComponent){
    ...
    public static DataChooser getInstance(java.util.Date date, String format,JComponent showComponent){
        return new DataChooser(date, format, defaultStartDAY,showComponent);
    }

    public static DataChooser getInstance(java.util.Date date,JComponent showComponent){
        return getInstance(date, DEFAULTFORMAT,showComponent);
    }
    public static DataChooser getInstance(String format,JComponent showComponent){
        return getInstance(new java.util.Date(), format,showComponent);
    }
    public static DataChooser getInstance(JComponent showComponent){
        return getInstance(new java.util.Date(), DEFAULTFORMAT, showComponent);
    }
    ...
    private class LabelManager {
        ...
        public LabelManager(){
            list = new ArrayList<DataChooser.DayLabel>();
        }
    ...
    public static void main(String[] args) {
        ...
        DataChooser ser = DataChooser.getInstance("yy-MM-dd",text);
        text.setBounds(10, 10, 200, 30);
        text.setText("2016-07-27");
        ser.register();
        
        JLabel label = new JLabel("please click me.");
        DataChooser ser2 = DataChooser.getInstance("yyyy年MM月dd日",label);
